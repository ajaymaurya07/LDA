...
import com.example.lda.model.NotCaRejoinderFiledResultItem
import com.example.lda.utils.getLabelValueText

class NotCaRejAdaptor(
    private val caseList: MutableList<NotCaRejoinderFiledResultItem?> = mutableListOf(), val context: Context
) : RecyclerView.Adapter<NotCaRejAdaptor.CaseViewHolder>() {
    ...
    fun updateList(newList: List<NotCaRejoinderFiledResultItem?>?) {
        caseList.clear()
