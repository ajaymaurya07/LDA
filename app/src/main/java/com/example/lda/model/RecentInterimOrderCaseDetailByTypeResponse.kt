...
data class RecentInterimOrderCaseDetailByTypeResponse(

    @field:SerializedName("status_message")
    val statusMessage: String? = null,

    @field:SerializedName("result")
    val result: List<RecentInterimResultItem?>? = null,

    @field:SerializedName("status_code")
    val statusCode: String? = null
)

data class RecentInterimResultItem(

    @field:SerializedName("next_hearing")
    val nextHearing: String? = null,

    @field:SerializedName("interim_calculated_deadline")
    val interimCalculatedDeadline: String? = null,
    ...
    @field:SerializedName("interim_order_date")
    val interimOrderDate: String? = null,
)
