...
data class NextHearingResponse(

	@field:SerializedName("status_message")
	val statusMessage: String? = null,

	@field:SerializedName("result")
	val result: List<NextHearingResult?>? = null,
...
@Parcelize
data class NextHearingResult(

	@field:SerializedName("hearing_count")
	val hearingCount: String? = null,
